...
const UserHome = () => {
   ...
   const getUserData = async () => {
      try {
         await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/users/getuserdata`, {}, {
            headers: {
   ...
   const getDoctorData = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/users/getalldoctorsu`, {
            headers: {
               Authorization: "Bearer " + localStorage.getItem('token')
            },
         });
